...
OUTPUT_CANDIDATES = TABLES_DIR / "dynamic_state_space_extended_no_sector_candidate_results.csv"
OUTPUT_SELECTED_RESULTS = TABLES_DIR / "dynamic_state_space_extended_no_sector_selected_model_results.csv"
OUTPUT_RESIDUAL_DIAGNOSTICS = TABLES_DIR / "dynamic_state_space_extended_no_sector_residual_diagnostics.csv"
OUTPUT_COEFFICIENTS = TABLES_DIR / "dynamic_state_space_extended_no_sector_coefficients_by_date.csv"
OUTPUT_PREDICTIONS = REGRESSION_DIR / "dynamic_state_space_extended_no_sector_gap5_model_predictions.parquet"
OUTPUT_MANIFEST = TABLES_DIR / "dynamic_state_space_extended_no_sector_manifest.json"

FIG_VALIDATION_RMSE = FIGURES_DIR / "dynamic_state_space_extended_no_sector_validation_rmse.png"
FIG_TEST_OOS_R2 = FIGURES_DIR / "dynamic_state_space_extended_no_sector_test_oos_r2_vs_expanding_m0.png"
FIG_COEFFICIENTS_GLOBAL = FIGURES_DIR / "dynamic_state_space_extended_no_sector_global_coefficients_over_time.png"
FIG_ABS_RESIDUAL_ECDF = FIGURES_DIR / "dynamic_state_space_extended_no_sector_abs_residual_ecdf.png"
...
def build_expanding_static_predictions(
    ...
    for month_start in eval_months:
        ...
        prediction_parts.append(
            make_prediction_frame(
                df=month_rows,
                model_name="Expanding_OLS_M4NoSector",
                model_family="expanding_fixed_effects",
...
def plot_validation_candidates(candidate_results: pd.DataFrame) -> None:
    ...
    plt.title("Extended no-sector DLM validation RMSE")
...
def plot_test_oos_r2(results: pd.DataFrame) -> None:
    ...
    plt.title("Extended no-sector dynamic state-space comparison")
    plt.tight_layout()
...
def plot_global_coefficients(coefficients: pd.DataFrame) -> None:
    ...
    g = coefficients.loc[
        coefficients["model"].eq("DLM_Kalman_M4NoSector_expandingFE_global_beta")
    ...
    plt.title("Kalman filtered M4 no-sector coefficients with expanding fixed effects")
    plt.legend(fontsize=8)
    plt.tight_layout()
...
def main() -> None:
    ...
    print("Extended no-sector dynamic state-space panel")
    ...
    dynamic_specs = [
        {
            "model": "DLM_Kalman_M4NoSector_expandingFE_global_beta",
            "group_cols": [],
        },
        {
            "model": "DLM_Kalman_M4NoSector_expandingFE_issuer_beta",
    ...
    model_order = [
        "Expanding_M0_FE",
        "Expanding_OLS_M4NoSector",
        "DLM_Kalman_M4NoSector_expandingFE_global_beta",
        "DLM_Kalman_M4NoSector_expandingFE_issuer_beta",
        "DLM_Kalman_M4NoSector_expandingFE_issuer_maturity_beta",
    ]
    ...
    manifest = {
        ...
        "dropped_peer_features": DROPPED_PEER_FEATURES,
        "peer_block_variant": "same_issuer_plus_other_bank_only",
        "split_dates": {
